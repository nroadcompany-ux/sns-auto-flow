...
- Name: sfa-audit.spec.ts >> SNS FLOW AUTO — 전수 기능 검사 >> 보관함 탭 — 빈 상태 메시지
- Location: tests\sfa-audit.spec.ts:217:7
...
Locator: locator('text=저장된 소재가 없어요')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=저장된 소재가 없어요')
...
- complementary:
  ...
  - navigation:
    ...
    - button "진단":
      ...
      - text: 진단
- main:
  - text: 소재 보관함 생성된 전체 소재 · 채널별 복사 · 발행 일정으로 이동
  - button "새로고침"
  - button "전체"
  - button "임시저장"
  - button "예약됨"
